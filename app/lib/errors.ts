...
import {
  ...
  VAULT_ERROR__INSUFFICIENT_COLLATERAL,
  VAULT_ERROR__LOAN_ALREADY_LIQUIDATED,
  VAULT_ERROR__LOAN_ALREADY_REPAID,
  VAULT_ERROR__LOAN_NOT_YET_DUE,
  VAULT_ERROR__POOL_INSUFFICIENT_FUNDS,
  type VaultError,
} from "../generated/vault";

const VAULT_ERROR_CODES: Record<number, VaultError> = {
  [VAULT_ERROR__LOAN_ALREADY_REPAID]: VAULT_ERROR__LOAN_ALREADY_REPAID,
  [VAULT_ERROR__LOAN_NOT_YET_DUE]: VAULT_ERROR__LOAN_NOT_YET_DUE,
  [VAULT_ERROR__LOAN_ALREADY_LIQUIDATED]: VAULT_ERROR__LOAN_ALREADY_LIQUIDATED,
  [VAULT_ERROR__INSUFFICIENT_COLLATERAL]: VAULT_ERROR__INSUFFICIENT_COLLATERAL,
  [VAULT_ERROR__POOL_INSUFFICIENT_FUNDS]: VAULT_ERROR__POOL_INSUFFICIENT_FUNDS,
};
